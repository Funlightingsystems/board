...
class M1Monitor {
    static start() {
        ...
        let temperatureLookupSensors = [];
        let temperatureSensors = new Map();
...
switch (OS.hostname()) {
    case "MAC": {
        currentDeviceInfo.deviceName = "Macbook Air";
        M1Monitor.start();
        PersonalSystem.start();
        break;
    }
    case "LINUX": {
        currentDeviceInfo.deviceName = "Main Controller";
