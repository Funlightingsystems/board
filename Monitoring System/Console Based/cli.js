...
var host = "http://10.0.0.169:38492";
...
function update() {
    var clientRequest = HTTPs.request(host + "/GetDeviceStatus?authenticationKey=some%20more%20keys", {
        method: "GET",
        ...
        incomingMessage.on("end", function () {
            ...
            for (var i in devices) {
                ...
                if (device.power.supported) {
                    ...
                    rightStatusText += "-----";
                    rightStatusText = "".concat(" ".repeat(Math.max(0, 100 - leftStatusText.length))).concat(rightStatusText);
